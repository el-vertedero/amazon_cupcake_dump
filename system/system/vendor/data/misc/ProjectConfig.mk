...
AUTO_ADD_GLOBAL_DEFINE_BY_VALUE = CUSTOM_HAL_LENS BOOT_LOGO MTK_AUDIO_BLOUD_CUSTOMPARAMETER_REV MTK_PLATFORM CUSTOM_KERNEL_LENS CUSTOM_KERNEL_MAIN_BACKUP_LENS CUSTOM_KERNEL_LCM MTK_MODEM_SUPPORT CUSTOM_KERNEL_MAIN_IMGSENSOR MTK_BT_CHIP MTK_WLAN_CHIP CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR CUSTOM_KERNEL_FLASHLIGHT CUSTOM_KERNEL_SUB_IMGSENSOR CUSTOM_KERNEL_SUB_LENS CUSTOM_KERNEL_IMGSENSOR MTK_FM_RX_AUDIO MTK_COMBO_CHIP MTK_GPS_CHIP CUSTOM_KERNEL_SUB_BACKUP_LENS CUSTOM_KERNEL_MAIN_LENS MTK_FM_TX_AUDIO MTK_FM_CHIP CUSTOM_KERNEL_MAIN2_IMGSENSOR BOOT_LOGO
BOOT_LOGO = wsvga
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
...
CUSTOM_HAL_CAMERA = no
CUSTOM_HAL_CAM_CAL = no
CUSTOM_HAL_COMBO = mt7668
CUSTOM_HAL_EEPROM = dummy_eeprom
CUSTOM_HAL_FLASHLIGHT = no
CUSTOM_HAL_IMGSENSOR = no
CUSTOM_HAL_LENS = no
CUSTOM_HAL_MAIN2_IMGSENSOR = no
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR = no
CUSTOM_HAL_MAIN_BACKUP_LENS = no
CUSTOM_HAL_MAIN_IMGSENSOR = no
CUSTOM_HAL_MAIN_LENS = no
CUSTOM_HAL_MSENSORLIB = no
CUSTOM_HAL_SENSORS =
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR = no
CUSTOM_HAL_SUB_BACKUP_LENS = no
CUSTOM_HAL_SUB_IMGSENSOR = no
CUSTOM_HAL_SUB_LENS = no
...
CUSTOM_KERNEL_CAMERA = no
CUSTOM_KERNEL_CAM_CAL = no
...
MTK_DYNAMIC_IMS_SWITCH_SUPPORT = no
MTK_EAP_SIM_AKA = no
...
MTK_RELEASE_PACKAGE = rel_customer_basic rel_customer_kernel_4-4 rel_customer_modem rel_customer_tablet
